...
<section class="about-sec-4 sec-bg py-150">
  <div class="container">
    ...
    data-aos-duration="1000">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="services-card-wrapper">
          <img src="./assets/images/services/02.png" class="mb-10" alt="Custom Branding & Personalization">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="services-card-wrapper">
          <img src="./assets/images/services/03.png" class="mb-10" alt="Seamless Ordering & Delivery">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="services-card-wrapper">
          <img src="./assets/images/services/04.png" class="mb-10" alt="Bulk Gifting Made Easy">
