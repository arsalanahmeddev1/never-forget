  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h1 class="fs-74 heading mb-30" style="max-width: 625px">
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        ...
        <a href="" class="btn primary-btn border-0">More About Us</a>
      </div>
    </div>
  </div>
</section>
<section class="solutions-sec">
  <div class="container me-0">
    <div class="col-lg-6">
      ...
      <h2 class="heading fs-64 mb-30" style="max-width: 500px">
        Our Corporate
        <span>Solutions</span>
      </h2>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6 text-center pb-60" style="max-width: 677px">
        <span class="btn des-wrapper mb-30">Never Forget Showing Appreciation</span>
        <h2 class="heading fs-64 mb-30">
          Who Can Benefit from Our Corporate
          <span>Gifting Services?</span>
        </h2>
      </div>
    </div>
    <div class="d-flex align-items-center gap-11 mb-30">
...
<section class="testimonials-sec">
  <div class="container">
    <div class="text-center">
      <span class="btn des-wrapper mb-20">Never Forget Showing Appreciation</span>
      <h2 class="heading fs-64 mb-20">
        Testimonials
      </h2>
      <p class="mx-auto mb-30" style="max-width: 470px">
