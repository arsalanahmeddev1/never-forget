  ...
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic"
        ...
        <ul class="plans-list check-list">
          <li class="">
            <b>Work Anniversaries & Milestones</b>
            - Celebrate employee loyalty <br> with meaningful gifts that make them feel valued.
          </li>
          <li><b>Performance Rewards & Incentives</b> - Motivate your team <br> with exclusive rewards for outstanding achievements.</li>
          <li><b>Wellness & Care Packages</b> - Promote well-being with carefully <br> selected wellness-themed gifts.</li>
        </ul>
  ...
  <div class="container">
    <div class="row justify-content-between">
      ...
      <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic"
        ...
        <ul class="plans-list check-list">
          <li class="">
            <b>Custom Thank You Gifts </b>
            - Express gratitude with personalized gifts <br> that make a lasting impression.
          </li>
          <li><b>VIP & Executive Gifting</b> - Elevate your brand with premium gifts for <br> high-value clients and partners.</li>
          <li><b>Personalized Touch</b> - Add custom messages, branding, or <br> engraving for a unique and thoughtful experience.</li>
        </ul>
        <a href="" class="btn primary-btn border-0">Get A Quote</a>
      </div>
      ...
      <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic"
        ...
        <ul class="plans-list check-list">
          <li class="">
            ...
            - Feature your logo on elegant, high-end <br> gift items.
          </li>
          <li><b>Custom Packaging</b> - Impress recipients with beautifully designed <br> packaging that reflects your brand identity.</li>
          <li><b>Exclusive Corporate Merchandise</b> - Choose from a range of custom- <br>branded gifts, from luxury accessories to practical office essentials.</li>
        </ul>
        <a href="" class="btn primary-btn border-0">Get A Quote</a>
      </div>
      <div class="col-lg-6">
