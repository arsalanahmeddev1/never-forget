...
<main class="inner-bg">
  ...
  <section class="inner-banner">
    <div class="container">
      <h1 class="heading fs-74">How It <span>Works</span></h1>
    </div>
  </section>
</main>
...
<section class="hiw-sec-3">
  <div class="container">
    <div class="row">
      <div class="col-lg-3">
        <span class="btn secondry-btn border-black border-1" style="padding: 10px 32px">Step 1</span>
        <h2 class="heading fs-74 mt-10">Choose a <span>Gifting</span> Plan</h2>
      </div>
      <div class="col-lg-3">
      ...
      <div class="col-lg-12 text-center mt-70">
        ...
        <div class="d-flex align-content-center justify-content-center">
          <a href="" class="btn primary-btn border-0">Contact Our Team</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="img-wrapper position-relative">
          <img src="./assets/images/hiw-sec-4.png" alt="">
        </div>
      </div>
      <div class="col-lg-6">
        <span class="btn secondry-btn border-black border-1" style="padding: 10px 32px">Step 2</span>
        ...
        <a href="" class="btn primary-btn border-0">Contact Us For Customize Gifting</a>
      </div>
    </div>
  </div>
</section>
<section class="hiw-sec-5 sec-bg py-150">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6">
        <span class="btn secondry-btn border-black border-1" style="padding: 10px 32px">Step 3</span>
        ...
        <a href="" class="btn primary-btn border-0">Contact Us For Gifting Plans</a>
      </div>
      <div class="col-lg-6">
        <div class="img-wrapper position-relative">
          <img src="./assets/images/hiw-sec-5.png" alt="">
        </div>
      </div>
    </div>
  </div>
...
<section class="hiw-sec-6 py-150">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="img-wrapper position-relative">
          <img src="./assets/images/hiw-sec-6.png" alt="">
        </div>
      </div>
      <div class="col-lg-6">
        <span class="btn secondry-btn border-black border-1" style="padding: 10px 32px">Step 4</span>
  ...
  <div class="container">
    <div class="row text-center justify-content-center mb-60">
      <div class="col-lg-6">
        ...
        <p>With our seamless gifting solutions, you can show appreciation in a meaningful and professional way.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6 col-lg-4">
...
<section class="hiw-sec-8 pb-150">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <img src="./assets/images/hiw-sec-7.png" class="mb-40" alt="">
        <h4 class="light-black mb-10 fs-32 fw-600 text-center">Looking for a fully customized gifting solution? </h4>
        <p class="text-center mb-30">Contact us to create a tailored plan that perfectly suits your business needs!</p>
        <div class="d-flex justify-content-center text-area">
          <a href="" class="btn primary-btn border-0 text-center">Contact Our Team</a>
        </div>
      </div>
    </div>
  </div>
