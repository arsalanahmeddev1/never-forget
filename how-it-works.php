  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic"
        data-aos-duration="1000">
        <span class="btn border-black border-1" style="padding: 10px 32px">Step 3</span>
...
<section class="hiw-sec-6 py-150">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic"
        data-aos-duration="1000">
        <span class="btn border-black border-1" style="padding: 10px 32px">Step 4</span>
...
<section class="hiw-sec-7 pb-60">
  <div class="container">
    <div class="row text-center justify-content-center mb-60">
      <div class="col-lg-6">
        <h3 class="heading fs-74 mb-20" data-aos="flip-left" data-aos-easing="ease-out-cubic"
          data-aos-duration="1000">
