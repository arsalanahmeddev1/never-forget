    ...
    <div class="row row-gap-40">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/1.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/2.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/3.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/4.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/5.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/6.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/7.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/8.png" class="w-100 mb-10" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blogs-card-wrapper">
          <img src="./assets/images/blogs/9.png" class="w-100 mb-10" alt="">
